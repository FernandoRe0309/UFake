...
const navItems = [
  { href: "/student", icon: LayoutDashboard, label: "Mis Cursos" },
  { href: "/student/catalog", icon: BookOpen, label: "Catalogo" },
  { href: "/student/certificates", icon: Award, label: "Certificados" },
